...
exports.queries = {
  getInventory: `SELECT ad.name, adm.name AS model_name, adve.name AS version_name, adva.name AS variant_name, ad.mac_number, ad.color From ${dbTables.DEVICE_TABLE} AS ad JOIN ${dbTables.DEVICE_MODELS_TABLE}
